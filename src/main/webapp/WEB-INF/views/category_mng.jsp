		...
		<div class="card">
			<div class="card-body">
					   ...
					   <form class="d-flex mt-2">
						<input class="form-inline search_input" type="text" value=" " id="largeFileChunkSize">
						<button type="search" class="btn btn-secondary waves-effect waves-light mr-2">검색</button>
			    </form>
						...
						<!--상품 검색결과-->
				        <div>
				        <img src="../../resources/static/assets/images/product.png" width="100%" alt=""/></div>
					  ...
					  <div class="active mt-2">
						...
						<button type="search" class="btn btn-secondary btn-sm waves-effect waves-light mr-2">검색</button><button type="search" class="btn btn-info btn-sm waves-effect waves-light">직접추가</button>
						 ...
						 <div class="frl_box mb-1 mt-3">
							...
							<div class="float-right">
							<a href="" data-toggle="modal" data-target="#USER-registration" class="btn_up" title="사전 등록"></a>
							</div>
						</div>
<!--The Modal:사전 등록-->
...
<!--end The Modlal:파일 내려받기-->						  
						...
						<!--end paging nav--> 
						<div class="mt-5">
						<span class="t_dot_L mt-2">형태소 분석 결과</span>
						<div class="box_line p-3">
				...
				<div class="p-0">
					<div class="contents">
					  <div class="active mt-2">
						<div class="frl_box mb-2">
							<div class="float-left">
								<span class="t_dot_L">Display 카테고리</span>
							</div>
						...
						<button type="search" class="btn btn-secondary btn-sm waves-effect waves-light mr-2">검색</button><button type="search" class="btn btn-info btn-sm waves-effect waves-light">직접추가</button>
						 ...
						 <div class="frl_box mb-1 mt-3">
							...
							<div class="float-right">
							<a href="" class="btn_down" title="사전 내려받기" data-toggle="modal" data-target="#file-download"></a>
							</div>
						</div>
						<div class="h_400_s">
						<table class="table table-bordered border-gray table-hover t_select mb-0 align-c">
							<colgroup>
							 ...
							 <tr>
								 ...
								 <th>Display 카테고리<span class="sorting_set"><a href="#" class="sorting_up" title="정렬"></a><a href="#" class="sorting_down" title="정렬"></a></span></th>
				...
				<div class="p-0">
					<div class="contents">
					  <div class="active mt-2">
						<div class="frl_box mb-2">
							<div class="float-left">
								<span class="t_dot_L">Delete 카테고리</span>
							</div>
						...
						<table class="table table-bordered border-gray table-hover t_select mb-0 align-c">
							<colgroup>
							 ...
							 <tr>
								 ...
								 <th>Delete 카테고리<span class="sorting_set"><a href="#" class="sorting_up" title="정렬"></a><a href="#" class="sorting_down" title="정렬"></a></span></th>
